...
class AboutSymbols < Neo::Koan
  ...
  #This question gave me a hard time. 
  #I ran line 29 in IRB then ran the second half of line 30
  #IRB returns false, but the path_to_enlightenment calls for true
